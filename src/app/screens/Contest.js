        ...
        return(
            <div className="screen" id="contest">
                ...
                <div className="content">
                    <p className="text">
                        Navštívte náš <Link to="/e-shop" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>e-shop</Link> a vyberte si z ponuky produktov doTERRA v minimálnej hodnote 100 bodov (približne 125 €). V nákupnom procese kliknite na otvorenie účtu. Za svoj nákup zaplatíte o <b>25% menej</b>. Navyše získate vlastný účet a <Link to="/e-shop/3-vonavy-pomonik-slovencina" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>Voňavého pomocníka</Link> ako darček. 
                        <div style={{ height: 50 }} />
                        Najvýhodnejšie je si však vybrať jeden zo <b>Zvýhodnených balíkov</b>. Napríklad pri kúpe <Link to="/e-shop/1-velky-balik-nevyhnutnosti-pre-domacnost" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>Veľkého balíka</Link> získate esenciálne oleje a difuzér v hodnote 461,33€ za cenu 270€! Ako <b>BONUS</b> k vlastnému účtu Vám pošleme <Link to="/e-shop/wild-orange-15-ml-pomaranc-olej-hojnosti" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>15ml Wild Orange</Link>, <Link to="/e-shop/3-vonavy-pomonik-slovencina" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>Voňavého pomocníka</Link> a <Link to="/e-shop/emocne-koliesko-pre-jednoduchsie-zvladanie-emocii" style={{ textDecoration: "none", color: "#A161B3", fontWeight: "bold" }}>Emočné koliesko</Link> pre jednoduchšie zvládanie emócií a taktiež získate wellness konzultáciu.
                    </p>
